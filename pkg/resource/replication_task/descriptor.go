...
const (
	FinalizerString = "finalizers.dms.services.k8s.aws/ReplicationTask"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("replicationtasks")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.ReplicationTask{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.ReplicationTask),
	}
}
