...
const (
	FinalizerString = "finalizers.dms.services.k8s.aws/ReplicationSubnetGroup"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("replicationsubnetgroups")
	GroupKind            = metav1.GroupKind{
		Group: "dms.services.k8s.aws",
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.ReplicationSubnetGroup{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.ReplicationSubnetGroup),
	}
}
