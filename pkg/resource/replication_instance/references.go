...
func (rm *resourceManager) ClearResolvedReferences(res acktypes.AWSResource) acktypes.AWSResource {
	...
	if ko.Spec.ReplicationSubnetGroupRef != nil {
		ko.Spec.ReplicationSubnetGroupID = nil
	}
...
func (rm *resourceManager) ResolveReferences(
	...
	if fieldHasReferences, err := rm.resolveReferenceForReplicationSubnetGroupID(ctx, apiReader, ko); err != nil {
		return &resource{ko}, (resourceHasReferences || fieldHasReferences), err
	} else {
		resourceHasReferences = resourceHasReferences || fieldHasReferences
	}
...
func validateReferenceFields(ko *svcapitypes.ReplicationInstance) error {
	...
	if ko.Spec.ReplicationSubnetGroupRef != nil && ko.Spec.ReplicationSubnetGroupID != nil {
		return ackerr.ResourceReferenceAndIDNotSupportedFor("ReplicationSubnetGroupID", "ReplicationSubnetGroupRef")
	}
	return nil
}
...
// resolveReferenceForReplicationSubnetGroupID reads the resource referenced
// from ReplicationSubnetGroupRef field and sets the ReplicationSubnetGroupID
// from referenced resource. Returns a boolean indicating whether a reference
// contains references, or an error
func (rm *resourceManager) resolveReferenceForReplicationSubnetGroupID(
	ctx context.Context,
	apiReader client.Reader,
	ko *svcapitypes.ReplicationInstance,
) (hasReferences bool, err error) {
	if ko.Spec.ReplicationSubnetGroupRef != nil && ko.Spec.ReplicationSubnetGroupRef.From != nil {
		hasReferences = true
		arr := ko.Spec.ReplicationSubnetGroupRef.From
		if arr.Name == nil || *arr.Name == "" {
			return hasReferences, fmt.Errorf("provided resource reference is nil or empty: ReplicationSubnetGroupRef")
		}
		namespace := ko.ObjectMeta.GetNamespace()
		if arr.Namespace != nil && *arr.Namespace != "" {
			namespace = *arr.Namespace
		...
		ko.Spec.ReplicationSubnetGroupID = (*string)(obj.Spec.Name)
	}
