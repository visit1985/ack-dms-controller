...
const (
	FinalizerString = "finalizers.dms.services.k8s.aws/ReplicationInstance"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("replicationinstances")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.ReplicationInstance{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.ReplicationInstance),
	}
}
